        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body pb0">
                    {!! Form::open(['id' => 'post-creation-form']) !!}
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-1 col-sm-2 control-label">Cite:</label>
                            <div class="col-md-11 col-sm-10">
                                {{ Form::select('cite', $cite, false, ['class' => 'form-control']) }}
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-11 col-sm-10">
                                {{ Form::textarea('content['.$default_language_id.']', false, ['class' => 'form-control', 'rows' => 3]) }}
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        ...
                        @foreach($languages as $language)
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-11 col-sm-10">
                                        {{ Form::textarea('content['.$language->id.']', false, ['class' => 'form-control', 'rows' => 3]) }}
                                    </div>
                                </div>
                            </fieldset>
                        @endforeach
