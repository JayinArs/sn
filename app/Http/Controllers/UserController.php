...
class UserController extends Controller
{
	...
	public function userFollowingOrganizations($id)
    {
	    ...
	    OrganizationFollower::with(['organization_location.organization', 'organization_location.organization.meta_data'])->where('user_id', $id)->each(function($follower) use (&$organizations) {
